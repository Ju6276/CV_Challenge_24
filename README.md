...
<p align="center">
  <img src="https://raw.githubusercontent.com/junpeng2023/TIP/main/img/oil-painting_right.jpg" alt="Right View" width="300" style="margin-right: 20px;">
  <img src="https://raw.githubusercontent.com/junpeng2023/TIP/main/img/oil-painting_above.jpg" alt="Above View" width="300">
</p>
...
### 4. Rendering
In order to map the texture to corresponding 3D surfaces , we implement rendering process in `applyMask.m`, SurfImage.m and `Rendering.m` using `surf()` for three-dimensional surface plot to visualize the rendered results in a xyz plot based on that. 
...
Some demo videos and images can be found in the following QR Code:
<p align="center">
  <img src="https://raw.githubusercontent.com/junpeng2023/TIP/main/img/qr_code_xiaolin.jpg" alt="Right View" width="150" style="margin-right: 20px;">
  
</p>


## Contact
For further questions, please contact us at ge53kan@mytum.de.

## Acknowledgements
Many thanks to all team members who contributed to this project:
-  <img src="https://github.com/junpeng2023.png" width="20" height="20" style="border-radius: 50%"> Junpeng Chen
- <img src="https://github.com/Ju6276.png" width="20" height="20" style="border-radius: 50%"> Ju Dong
- <img src="https://github.com/Xiaolin80.png" width="20" height="20" style="border-radius: 50%"> Xiaolin Li
- <img src="https://github.com/yfylzy.png" width="20" height="20" style="border-radius: 50%"> Zhiyun Li
- <img src="https://github.com/yfylzy.png" width="20" height="20" style="border-radius: 50%"> Fengyi Yu
- <img src="https://github.com/Xiaolin80.png" width="20" height="20" style="border-radius: 50%"> Nan Zhou
