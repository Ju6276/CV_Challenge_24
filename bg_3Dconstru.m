function [twelfPoints_3D,Vanishing_point_3D] = bg_3Dconstru(points, k)
...
%points: 2D coordinates of the 12 points + vanishing point
    ...
    Vanishing_point_3D = twodim_threedim(x_v,y_v,x_v,y_v);
