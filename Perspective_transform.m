function rectangle = Perspective_transform(input_image, corners, outH, outW)
% Implement of the perspective transformation
% Convert a trapezoidal image to a rectangular image and output it.
